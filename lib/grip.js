...
var pubcontrol = require('../../node-pubcontrol/lib/pubcontrol.js');
...
var parseGripUri = function(uri) {
    ...
    var control_uri = uri.protocol + '//' + uri.host + path;
    if (qs && qs != '') {
        control_uri = control_uri + '?' + qs;
    }
    var out = {'control_uri': control_uri};
    if (iss) {
        out['control_iss'] = iss;
    }
    if (key) {
