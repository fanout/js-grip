...
(function testName() {
    var hf = new httpresponseformat.HttpResponseFormat('body');
    assert.equal(hf.name(), 'http-response');
})();

(function testExport() {
    var hf = new httpresponseformat.HttpResponseFormat({ body: 'body' });
